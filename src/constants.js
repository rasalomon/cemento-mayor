...
export const WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER || "59800000000";
export const COMPANY_EMAIL = import.meta.env.VITE_COMPANY_EMAIL || "contacto@cementomayor.com.uy";
